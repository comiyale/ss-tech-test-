...
class Facility implements JsonSerializable
{
    ...
    public function getRouteCounty(): ?string
    {
        return $this->routeCounty;
    }

    public function getRouteCity(): ?string
    {
        return $this->routeCity;
    }

    public function getRouteLocationCode(): ?string
    {
        return $this->routeLocationCode;
    }

    public function getRouteParams(): array
    {
        $this->routeState = Str::slugify($this->state);
        $this->routeCounty = Str::slugify($this->getFormattedCounty());
        $this->routeCity = Str::slugify($this->city);
        $this->routeLocationCode = Str::slugify($this->location_code);

        return [
            'state' => $this->getRouteState(),
            'county' => $this->getRouteCounty,
            'city' => $this->getRouteCity(),
            'location_code' => $this->getRouteLocationCode(),
        ];
    }
